...
2. Open Command Palette Ctrl+⇧Shift+P or ⌘Command+⇧Shift+P (macOS) `Cencurity: Enable Protection`.
3. Select your LLM provider.
4. Open Command Palette Ctrl+⇧Shift+P or ⌘Command+⇧Shift+P (macOS) `Cencurity: Open Security Center`.
